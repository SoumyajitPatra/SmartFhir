function getA1Cdata() {
  ...
  let container = document.getElementById('containerId'); let tblRow=null; let tblCell=null;tblRow = document.createElement('div');tblRow.classList.add('row'); tblCell = document.createElement('div');tblCell.className='col-sm-6';tblCell.setAttribute('style', 'padding: 40px;');tblRow.appendChild(tblCell);displayCalc(tblCell,'Fibrosis-4','age| *|alt');; tblCell = document.createElement('div');tblCell.className='col-sm-6';tblCell.setAttribute('style', 'padding: 40px;');tblRow.appendChild(tblCell);displayTable(tblCell,'MedicationRequest','Text|Status|Intent');;container.appendChild(tblRow);tblRow = document.createElement('div');tblRow.classList.add('row'); tblCell = document.createElement('div');tblCell.className='col-sm-6';tblCell.setAttribute('style', 'padding: 40px;');tblRow.appendChild(tblCell);displayBarChart(tblCell,'Observation','VITAL SIGN (Pressure)');; tblCell = document.createElement('div');tblCell.className='col-sm-6';tblCell.setAttribute('style', 'padding: 40px;');tblRow.appendChild(tblCell);displayLine(tblCell,'Observation','LAB (Createnine)');;container.appendChild(tblRow);
}
...
// var valuesStringify = JSON.stringify(values, null, 4);
        ...
        // medInfoTableDiv.appendChild(table);
        ...
        // row1Cell.appendChild(document.createTextNode(medInfoHeading3));
